...
\noindent\fbox{%
    \parbox{\textwidth}{%
        Coretta, Stefano. 2020. Temporal (in)stability in English monosyllabic and disyllabic words: Insights on the effect of voicing on vowel duration. Manuscript.
    }%
}
...
However, the temporal distance of the V-to-V interval is modulated by the number of intervening consonants \citep{smith1995, zmarich2011, zeroual2015}.
...
As it can be seen by comparing the top and bottom scheme of \Cref{fig:vv-cent-2} (a), the temporal distance between the two vowels differs in *pata* and *patta*, as per the results in \citet{smith1995}, \citet{zmarich2011} and \citet{zeroual2015}.
