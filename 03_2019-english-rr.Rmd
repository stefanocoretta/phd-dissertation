...
The data in \citet{sharf1962} and \citet{luce1985} indicate that voiced stop closures in English are 10-13 ms shorter than voiceless closures.
Given the paucity of studies on stop closure durations reporting statistical effects and related errors, no specific hypothesis was set in relation to this measurement.
Closure duration was nonetheless investigated as a conceptual replication of previous work and to produce posterior distributions that can be used to set up priors in the statistical analyses of future studies.
