...
The temporal stability of the release-to-release interval is compatible with a compensatory temporal adjustment account of the voicing effect \citep{lindblom1967, slis1969, slis1969a, lehiste1970a, lehiste1970}, and it offers a resolution to the drawbacks of previous versions of the account.
...
Other surveyed studies did not report effect sizes for stop closure durations \citep{port-1979, van-summers1987, de-jong1991}.
...
However, it was expected that English mono-syllabic words do not show such temporal stability, even though the voicing effect is present in this context and allegedly even grater than in disyllabic words (although cf. \Cref{s:ve-eng}).
