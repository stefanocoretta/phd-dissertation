...
source("./cache.R")
dir.create("./data/cache/03_2019-english-rr", showWarnings = FALSE)
```
...
rr_1 <- brm(
  ...
  cores = 4,
  seed = 1234,
  file = "./data/cache/03_2019-english-rr/model_1_rr"
)
```
...
kable(rr_1_tidy, linesep = "", digits = 2, caption = "Summary of the Bayesian regression fitted to release-to-release duration (model 1, see \\@ref(s:rr)).") %>%
...
rr_2 <- brm(
  ...
  cores = 4,
  seed = 1234,
  file = "./data/cache/03_2019-english-rr/model_2_rr"
)
```
...
kable(rr_2_tidy, linesep = "", digits = 2, caption = "Summary of the Bayesian regression fitted to release-to-release duration (model 2, see \\@ref(s:rr)).") %>%
kable_styling(font_size = 10)
```
...
rr_3 <- brm(
  ...
  cores = 4,
  seed = 1234,
  file = "./data/cache/03_2019-english-rr/model_3_rr"
)
```
...
kable(rr_3_tidy, linesep = "", digits = 2, caption = "Summary of the Bayesian regression fitted to release-to-release duration and predictors from model 1 and 2 (model 3, see \\@ref(s:rr)).") %>%
kable_styling(font_size = 10)
```
...
vow_4 <- brm(
  ...
  data = eng_durations,
  prior = priors,
  file = "./data/cache/03_2019-english-rr/model_4_vow",
  cores = 4
)
```
...
kable(vow_4_tidy, linesep = "", digits = 2, caption = "Summary of the Bayesian regression fitted to vowel duration (model 4, see \\@ref(s:vow)).") %>%
kable_styling(font_size = 10)
```
...
clos_5 <- brm(
  ...
  prior = priors,
  cores = 4,
  file = "./data/cache/03_2019-english-rr/model_5_clos"
)
```
...
kable(clos_5_tidy, linesep = "", digits = 2, caption = "Summary of the Bayesian regression fitted to closure duration (model 5, see \\@ref(s:clos)).") %>%
kable_styling(font_size = 10)
```
