...
rr_1 <- brm(
  ...
  cores = 4,
  seed = 1234,
  file = "./r_cache/03_2019-english-rr/model_1_rr"
)
```
...
rr_2 <- brm(
  ...
  cores = 4,
  seed = 1234,
  file = "./r_cache/03_2019-english-rr/model_2_rr"
)
```
...
rr_3 <- brm(
  ...
  cores = 4,
  seed = 1234,
  file = "./r_cache/03_2019-english-rr/model_3_rr"
)
```
...
vow_4 <- brm(
  ...
  data = eng_durations,
  prior = priors,
  file = "./r_cache/03_2019-english-rr/model_4_vow",
  cores = 4
)
```
...
clos_5 <- brm(
  ...
  prior = priors,
  cores = 4,
  file = "./r_cache/03_2019-english-rr/model_5_clos"
)
```
