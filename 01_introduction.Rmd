...
After fitting, the splines are linearly interpolated from the original frame rate to a sampling rate of 100 kHz.
...
The splines Cartesian coordinates were converted to polar for statistical analysis (see \Cref{a:polar-gams}).
