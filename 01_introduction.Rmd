...
The chapters of Part II set the ground for a synthesis of their results, discussed in \Cref{s:pluralist} and \Cref{s:gestural-phasing}, which in turn form the basis for a comparison of Italian, Polish, and English in \Cref{s:cross-ling-diff}.
