...
This section will review the physical and the linguistic in turn.
After providing a physical definition of voicing as periodicity and vocal fold vibration, I will review some of the views on how voicing can be defined linguistically.
Finally, I will introduce the notions of "descriptive category" and "comparative concept" \citep{haspelmath2010} to show that voicing in the linguistic reading will be used in the latter sense in this dissertation.
...
Similarly, the absence of voicing with no cuncurrent adjustments to prevent initiation and maintanence of vocal fold vibration is knows as *passive devoicing*.
Passive devoicing can be observed in the voiceless closure of stops, and a sign of passive devoicing is the continuing presence of vocal fold vibration from the preceding voiced sound for some time into the closure (also know as voicing bleed, \citealt{davidson2016}).
...
Active articulatory adjustmenst require muscular activity.
Among the solutions to help sustaining vocal fold vibration there are some that decrease supra-glottal pressure like tongue root advancement \citep{kent1969, perkell1969, westbury1983}, larynx lowering \citep{riordan1980}, opening of the velopharyngeal port \citep{yanagihara1966}, producing a retroflex occlusion \citep{sprouse2008}, and other that lower the pressure differential threshold required for fold vibration, like slackening of the vocal folds \citep{halle1967} or producing a shorter stop closure \citep{lisker1957}.
...
For example, glottal abduction, larynx raising, vocal fold tensing and oral wall tensing can all prevent passive voicing by either decresing the supra-glottal volume or raising the pressure differential threshold.
...
If tongue root advancement is executed by muscular activity with an intent different from maintining voicing, then this would be classified as a *non-purposive* (active) gesture in regards to voicing.
...
These languages are, even if at an alledgedly different extent, voicing-effect languages.
