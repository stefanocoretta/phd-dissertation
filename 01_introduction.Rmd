...
3. Replicating previous results and confidence of previous and current results.
 -->
...
Finally, ...
The methods of Study II are discussed in \Cref{s:studyii}, while \Cref{p:en-relrel} presents the results.
...
<!-- Question number 3 -->
Lastly, the third research aim is related the attempt to replicating previous results in relation to the voicing effect in the languages surveyed here, and the assessment the degree of confidence of previous and current results in terms of strength of evidence, in light of the issues and concepts reviewed in \Cref{s:openscience}.
