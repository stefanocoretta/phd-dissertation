...
\ctable[caption = Italian consonant phonemes (adapted from \citep[50]{kramer2009}).,
label = t:itacons,
]{llllll}{}{
FL
...
\ctable[caption = Italian vocalic phonemes (adapted from \citep[51]{kramer2009}).,
label = t:itavow,
]{llll}{}{
\FL
...
<!-- Pape 2014 talks about burst that could be used as a cue to voicelessness -->

The vocalic system in \Cref{t:itavow} is found in stressed syllables, although the status of the mid-high and mid-low contrast is not straightforward, and the mid vowels show a high degree of geographical and idiosyncratic variation \citep{renwick2016}.
...
\ctable[caption = Polish vocalic phonemes (adapted from ).,
label = t:polvow,
]{llll}{}{
\FL
         & front & central & back \ML
