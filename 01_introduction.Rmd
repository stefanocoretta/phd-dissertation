...
More specifically, I discuss how differences in the gestural organisation of mono- vs disyllabic words illuminates us on diachronic pathways and perceptual biases behind the voicing effect in these two phonological contexts.
...
The application of generalised additive models on electroglottographic data allows us to obtain a dynamic and multidimentional view of vibratory properties of the vocal folds (\Cref{\Cref{p:wavegram}}).
...
\Cref{a:polar-gams} in the Appendix shows how generalised additive modelling can be used with tongue contour data to control for complex random-effect structures.
...
Research methods...
Bayesian...
OS which encompasses this whole research project.
