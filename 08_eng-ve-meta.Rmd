...
h37_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/h37_bm"
)
```
...
hf53_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/hf53_bm"
)
```
...
z58_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/z58_bm"
)
```
...
pl60_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/pl60_bm"
)
```
...
s62_di_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/s62_di_bm"
)
...
s62_mono_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/s62_mono_bm"
)
```
...
c70_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/c70_bm"
)
```
...
k73_di_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/k73_di_bm",
...
k73_mono_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/k73_mono_bm",
  control = list(adapt_delta = 0.999)
)
```
...
m82_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/m82_bm"
)
```
...
l85_medial_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/l85_medial_bm"
)
...
l85_final_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/l85_final_bm"
)
```
...
d89_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/d89_bm"
)
```
...
l92_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/l92_bm"
)
```
...
k18_bm <- brm(
  ...
  prior = priors,
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/k18_bm"
)
```
...
meta_bm_syl <- brm(
  ...
  control = list(adapt_delta = 0.999),
  seed = 9899,
  file = "./r_cache/08_eng-ve-meta/meta_bm_syl"
)
