...
\Cref{fig:ve-int} shows the posterior distributions for the effects of language, voicing, centred speech rate, and language × voicing interaction.
...
If there is a difference, it will likely be about ±10 ms.
