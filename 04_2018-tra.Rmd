...
<!-- \begin{figure*}
    ...
    \caption{Schematic representation of the equipment setup (@articulate2011}). The system is described in details in \Cref{s:equipment}.}
    \label{fig:uti-setup}
\end{figure*} -->
...
Tongue root displacement was thus calculated as the displacement of the fitted spline along a selected vector [@strycharczuk2015, see \Cref{fig:trp}].
