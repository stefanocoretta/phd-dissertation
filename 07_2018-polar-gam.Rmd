...
stimuli_it <- read_csv("./datasets/stimuli-it.csv")

stimuli_pl <- read_csv("./datasets/stimuli-pl.csv")
...
tongue_it01 <- read_aaa("./datasets/it01-tongue-cart.tsv", columns)  %>%
  na.omit() %>%
...
tongue_it02 <- read_aaa("./datasets/it02-tongue-cart.tsv", columns)  %>%
  na.omit() %>%
  mutate(word = word(prompt, 2)) %>%
  left_join(y = stimuli_it) %>%
...
tongue_it03 <- read_aaa("./datasets/it03-tongue-cart.tsv", columns)  %>%
  na.omit() %>%
  mutate(word = word(prompt, 2)) %>%
  left_join(y = stimuli_it) %>%
...
tongue_it04 <- read_aaa("./datasets/it04-tongue-cart.tsv", columns)  %>%
  na.omit() %>%
  mutate(word = word(prompt, 2)) %>%
  left_join(y = stimuli_it) %>%
...
tongue_it07 <- read_aaa("./datasets/it07-tongue-cart.tsv", columns)  %>%
  na.omit() %>%
  mutate(word = word(prompt, 2)) %>%
  left_join(y = stimuli_it) %>%
...
tongue_it11 <- read_aaa("./datasets/it11-tongue-cart.tsv", columns)  %>%
  na.omit() %>%
  mutate(word = word(prompt, 2)) %>%
  left_join(y = stimuli_it) %>%
  filter(c1_phonation == "voiceless", label %in% c("max_TT", "max_TD")) %>%
...
tongue_pl02 <- read_aaa("./datasets/pl02-tongue-cart.tsv", columns)  %>%
  na.omit() %>%
  mutate(word = word(prompt, 2)) %>%
...
tongue_pl03 <- read_aaa("./datasets/pl03-tongue-cart.tsv", columns)  %>%
  na.omit() %>%
  mutate(word = word(prompt, 2)) %>%
  left_join(y = stimuli_pl) %>%
  filter(c1_phonation == "voiceless", label %in% c("max_TT", "max_TD")) %>%
...
tongue_pl04 <- read_aaa("./datasets/pl04-tongue-cart.tsv", columns)  %>%
  na.omit() %>%
  mutate(word = word(prompt, 2)) %>%
  left_join(y = stimuli_pl) %>%
  filter(c1_phonation == "voiceless", label %in% c("max_TT", "max_TD")) %>%
...
tongue_pl05 <- read_aaa("./datasets/pl05-tongue-cart.tsv", columns)  %>%
  na.omit() %>%
  mutate(word = word(prompt, 2)) %>%
  left_join(y = stimuli_pl) %>%
  filter(c1_phonation == "voiceless", label %in% c("max_TT", "max_TD")) %>%
...
tongue_pl06 <- read_aaa("./datasets/pl06-tongue-cart.tsv", columns)  %>%
  na.omit() %>%
  mutate(word = word(prompt, 2)) %>%
  left_join(y = stimuli_pl) %>%
...
tongue_pl07 <- read_aaa("./datasets/pl07-tongue-cart.tsv", columns)  %>%
  na.omit() %>%
  mutate(word = word(prompt, 2)) %>%
  left_join(y = stimuli_pl) %>%
