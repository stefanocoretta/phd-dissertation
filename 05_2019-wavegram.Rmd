...
```{r egg, fig.cap="The electroglottographic signal (EGG) with corresponding first derivative (dEGG)."}
knitr::include_graphics("./img/degg-signal.png")
```
...
An example EGG signal is provided in \@(fig:egg).
