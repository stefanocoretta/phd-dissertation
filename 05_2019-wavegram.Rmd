...
```{r load-data}
load("./data/cache/05_2019-wavegram/wavegam.Rdata")
```
...
```{r degg, include=TRUE, fig.cap="The electroglottographic signal (EGG) with corresponding first derivative (dEGG)."}
...
```{r wavegram, include=TRUE, fig.cap="The wavegram. Created by Christian T. Herbst under a CC BY-SA 3.0 license."}
knitr::include_graphics("./img/wavegram.png")
```
