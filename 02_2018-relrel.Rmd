...
@begus2017 argues that these findings support temporal compensation [although not univocally, see @begus2017, Section V; and \Cref{s:comp} of this paper].
...
In the present study, C2 voicing (voiceless, voiced) and its interactions are not significant when included in the model discussed in section \Cref{s:vcduration}, which has vowel duration as outcome and C2 closure duration as one of the predictors.^[Multicollinearity is not an issue here, since the VIFs are all below 3 [@zuur2010].]
