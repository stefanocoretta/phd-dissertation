...
\noindent\fbox{%
    \parbox{\textwidth}{%
        Coretta, Stefano. *forthcoming*. An exploratory study of voicing-related differences in vowel duration as compensatory temporal adjustment in Italian and Polish. To appear in *Glossa*.
    }%
}
...
\begin{figure}
  \centering
  \includegraphics[scale=1.3]{img/Figure6.pdf}
