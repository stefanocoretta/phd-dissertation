...
\noindent\fbox{%
    \parbox{\textwidth}{%
        Coretta, Stefano. \textit{forthcoming}. An exploratory study of voicing-related differences in vowel duration as compensatory temporal adjustment in Italian and Polish. To appear in \textit{Glossa}. DOI: \url{https://doi.org/10.31219/osf.io/8zm56}
    }%
}
...
A notable production account, which will be the focus of this study, is based on compensatory temporal adjustments [@lindblom1967; @slis1969; @slis1969a; @lehiste1970a; @lehiste1970].
...
Advocates of a compensatory mechanism propose two prosodic units as the scope of the temporal adjustment: the syllable (and, equivalently, the VC sequence or vowel-to-vowel interval, \citealt{lindblom1967, farnetani1986}), and the word [@slis1969; @slis1969a; @lehiste1970a; @lehiste1970].
...
Most are nonce words, although inevitably some combinations produce real words both in Italian (4 words) and Polish (2 words, see \Cref{a:targetsR}).
...
In accordance with a compensatory temporal adjustment account [@slis1969; @lehiste1970], the difference in vowel duration and closure durations before voiceless vs. voiced stops can be seen as the outcome of differences in timing of the vowel offset/closure onset (more neutrally, the VC boundary).
