...
\addcontentsline{toc}{section}{\nameref{s:acknowledgements}}

\begin{adjustwidth}{7cm}{}
{\tengwar    } \\
Elen síla lúmenn' omentielvo.\\
\textit{A star shines on the hour of our meeting.}
\end{adjustwidth}
...
I would have also not made it through without all of my friends in Manchester, especially (in order of appearance, because they are all dearest to me) ma' boy David, the Juan and only, Richard and Jaqui whose holy union I witnessed and cherished, Mark and Kat who offered me unconditional friendship and a roof when I most needed them. Also thanks to Mariana, Maxime, Gül, Valentina, Simena, Lucia, Edo, and to the friends I met in York but whom I found again in Manchester, thank you.

Thanks to my teachers and friends from Loto Blu, whose love has sustained me for all these years.
Thanks to Valentina A., with whom I share an irrepressible thrust to 'acquire for ourselves a knowledge of higher words'.
...
Without their direction and kindness, I would have lost my way and strayed, never to find again the will to persist along the path.
...
\begin{center}
{\nagari असंशयं महाबाहो मनो दुर्निग्रहं चलम् ।}\\
{\nagari अभ्यासेन तु कौन्तेय वैराग्येण च गृह्यते ॥ ६-३५॥}
...
\textit{O mighty-armed one, it is undoubtedly very difficult to curb the flickering mind, but it can be controlled, O son of Kunti, by constant practice and by detachment.} [BG 6.35]
\end{center}
