...
Allegedly, English is possibly the language possessing the biggest effect, while the effect is smaller in Italian and possibly absent in Polish.
However, Papers [...] and [...] indicate a somewhat less systematic difference between these languages.
...
Although the number of speakers included here is generally similar or greater than average (see \Cref{a:speakers}), the number of observations might not have been sufficient enough to reach an appreciable degree of precision.
...
This dissertation focuses on the voicing effect of stop consonants, but other manners of articulation participate in the effect.
...
\citet{zmarich2011} and \citet{zeroual2015} demonstrate that the temporal distance between two vowels with an intervening stop differs depending on whether the stop is a singleton or a geminate (the distance is greater in the latter case).
However, I argue that the absence of vowel-to-vowel isochrony in these contexts follows from the gestural organisation of the segments involved.
In the case of singleton stops, the vocalic gestures are immediately adjacent to each other, since onset consonant are allegedly realised synchronously with their tautosyllabic vowels.
In the case of geminates, on the other hand, the intervening (consonantal) gesture is in an anti-phase relation with the first vowel in the sequence so that the two vowels are separated by the consonant.
Since the two syllables are produced anti-phase relative to each other, the gesture of the second vowel is initiated after the completion of the intervening anti-phase gesture.
...
The acoustic patterns discussed in this dissertation assume that the distance between the vowels in CV.CV words is not affected by the second consonant and that the timing of the gestural onset and release are the same independent of voicing, while the velocity profiles of the closing gesture differs.
...
The temporal distance between the onsets or maxima of jaw displacement should be identical or very similar across voicing status, place, and manner of articulation of intervening consonant.
