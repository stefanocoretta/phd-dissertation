...
```{r gorganisation, include=TRUE, fig.cap="Gestural organisation patterns for onsets (a) and codas (b). C = consonant, V = vowel [design based on @marin2010]."}
...
```{r histve, include=TRUE, fig.cap="Schematics of the developmental/historical emergence of the voicing effect in disyllabic (a) and monosyllabic (b) words. See text for details."}
