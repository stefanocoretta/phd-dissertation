...
However, no single proposed explanation to date has reached unanimous consensus.
The golden period for the publications of accounts about the source of the voicing effect is the one between the 50s and the 70s, with subsequent decades focussing on testing or extending previous hypotheses.
A major distinction can be drawn between accounts that view the voicing effect as a consequence of articulatory or aerodynamic properties of speech production, and accounts that instead draw on biases of the perceptual system.
No ultimate answer as to which of the two sides best accounts for all of the aspects of the voicing effect, and rather both point of views partially contribute to the overall picture.
The following paragraphs review the most notable perception and production accounts, paving the way for a discussion of related phonation effects in the following chapter.
