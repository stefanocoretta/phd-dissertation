...
Such a precision requires greater time to be achieved during articulation than the production of closure voicelessness, which requires less precise control.
Because of these properties of laryngeal articulation, full closure can be achieved relatively faster in the context of voiceless stops, while a delay in closure onset with voiced stops ensures enough time to produce the suitable glottal configuration.
