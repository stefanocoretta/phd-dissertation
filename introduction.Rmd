...
In the academic world, great emphasis is given to the theoretical content of original research, whereas the scientific process that led to research findings is relegated to a subordinate position.
However, as brilliantly put by Chris Chambers, the methods section traditionally included in papers was originally meant to be a 'recipe' that would allow future researchers to follow and reproduce the steps used by the authors to go from a set of ideas to a set of results.
...
Matters of research transparency are part of a broader collection of problems, which have fuelled the birth of the international campaign which falls under the umbrella term Open Science.
