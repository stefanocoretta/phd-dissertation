...
The latter statement led to the idea that the voicing effect is phonologised in English \citet{dejong1991, sole2007, sanker2018}.
...
<!-- TODO: mention that data and processing are available at OSF, the following paragrapsh are documentation of the data and data processing -->
...
## The dark side of research and measurement practices
...
<!-- TODO: cognitive biases, see Roettger, confirmation hindsight etc -->
<!-- these and the QRMPs are not necessarily intentional or malicious, especially in the case of those practices that lie within a grey area of accepted standards -->

<!-- TODO: misconceptions of p-values? -->
<!-- wagenmakers problems p values, motulsky 2014 greenland 2016 in 8 steps for misconceptions -->
...
The questionable research and measurement practices described above, together with the publication bias, conspire to unduly increase confidence in our research outcomes.

<!-- TODO: Questionable Measurement practices... -->

## Reproducibility

<!-- TODO: reproducibility crisis -->
<!-- sandve 2013 for computational biology -->
...
Issues of reproducibility are not unknown to linguistics and phonetics/phonology (see the 'Yokuts vowels' case, \citealt{weigel2002, weigel2005, blevins2004}).
Ensuring full reproducibility also means ensuring computational reproducibility, or in other words enabling researchers to perform the original analysis on the original data in an identical computational environment \citep{fomel2009, peng2009}.
The ideas of accountability and reproducibility are not new to linguistics in general \citep{bird2003, thieberger2004, maxwell2005, maxwell2013, cysouw2015, gawne2017} and to phonetics/phonology specifically \citep{abari2012, roettger2018a}.
These objectives can be achieved by publicly sharing data (barring ethics restrictions), analysis code, and detailed information on the software that produced the results.

## Putting this into practice

<!-- TODO: putting this to practice -->
<!-- full *command* of these concepts was obtained while doing the project -->
<!-- also problems of time and resources, especially with UTI -->
<!-- pre-registered study, shared data, reproducible analyses -->
