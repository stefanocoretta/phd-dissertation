...
To provide a rationale for the language-specificity of the voicing effect, \citet{kluender1988} propose that different languages exploit biases of the perceptual system at different degrees.
...
While individual production accounts differ in the details, two broad categories can be identified, with two members each being representative of sub-categories.
